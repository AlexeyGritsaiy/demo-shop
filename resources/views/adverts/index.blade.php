                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <div class="filter-widget">
                     ...
                     <ul class="category-menu">
                                    ...
                                    @foreach ($categories as $chunk)
                                                    <li><a href="{{ route('adverts.index')}}">{{ $chunk->name }}</a></li>
                                    @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="filter-widget mb-0">
                        ...
                        <div class="fw-size-choose">
                            ...
                            @foreach(['xs', 'm','l', 'xxl', 'xxx3'] as $size)

                                <div class="sc-item">
                                    <input type="radio"
                                           {{ request()->get('size') === $size ? ' checked' : '' }}
...
{{--                                        <p>Categories: {{ implode(', ', $advert->getCategoryNamesList()) }}</p>--}}
                                    </div>
                                </div>
                            </div>
                        @endforeach
