...
@section('content')
    ...
    {{--        <input type="checkbox" name="status" value="{{ (bool)old('status', '0') }}">--}}

    {{--        <input type="text" value="m" name="size">--}}
    ...
    <div class="card card-default mb-3">
        <div class="card-body px-3 py-2" style="color: #aaa">
            <div class="row">
                <form method="GET" action="{{ route('adverts.index') }}" class="form-inline">
                    ...
                    <div class="form-group px-2 py-2">
                        <input type="number" class="form-control" name="priceFrom"
                               id="priceFrom" placeholder="цена от">
                    </div>
                    <div class="form-group px-2 py-2">
                        <input type="number" class="form-control" name="priceTo"
                               id="priceTo" placeholder="цена до">
                    </div>
...
{{--            @livewire('App\Http\Livewire\CartProduct', [--}}
{{--            'advert' => $advert--}}
{{--            ], key($advert->id))--}}
{{--        @endforeach--}}
{{--    </div>--}}
