...
Breadcrumbs::register('adverts.show', function (Crumbs $crumbs, Advert $advert) {
    $crumbs->parent('adverts.index', adverts_path($advert->category));
...
// Cabinet Adverts
Breadcrumbs::register('basket', function (Crumbs $crumbs) {
    $crumbs->parent('basket');
    $crumbs->push('basket', route('basket'));
});
Breadcrumbs::register('basket-place', function (Crumbs $crumbs) {
    $crumbs->parent('basket');
    $crumbs->push('basket-place', route('basket-place'));
});
...
Breadcrumbs::register('cabinet.adverts.photos', function (Crumbs $crumbs, Advert $advert) {
    ...
    $crumbs->push('Add photo', route('cabinet.adverts.photos', $advert));
});
...
Breadcrumbs::register('admin.adverts.adverts.edit', function (Crumbs $crumbs, Advert $advert) {
    ...
    $crumbs->push('Edit', route('admin.adverts.adverts.edit', $advert));
});
