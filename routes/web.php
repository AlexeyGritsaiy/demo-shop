...
//Livewire::component('basket',Cart::class);
...
Route::group(['prefix' => 'basket'], function () {
    Route::post('/add/{advert}', 'BasketController@basketAdd')->name('basket-add');
    ...
    Route::group([
        ...
        Route::post('/remove/{advert}', 'BasketController@basketRemove')->name('basket-remove');
...
Route::group(
    ...
    function () {
        ...
        Route::get('/importExportView', 'MyController@importExportView')->name('import');
        Route::post('/importExportView', 'MyController@import')->name('import');
...
Route::get('/{page_path}', 'PageController@show')->name('page');
