...
use App\Domain\Items\Entity\Item;
...
use App\Http\Requests\Admin\Adverts\AdvertRequest;
...
class AdvertController extends Controller
{
    ...
    public function editForm(Advert $advert)
    {
        ...
        return view('adverts.edit.advert', compact('advert', 'categories'));
    }

    public function edit(AdvertRequest $request, Advert $advert, AdvertPhotoService $photoService)
    {
        $advert->update(
            $request->only(['title', 'price', 'content'])
        );
        ...
        $photoService->addMedia($advert, $request->file('files'));

        return redirect()->route('admin.adverts.adverts.edit', $advert);
    }
